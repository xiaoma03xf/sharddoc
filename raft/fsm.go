...
func (f *Store) Apply(l *raft.Log) interface{} { return nil }

func (f *Store) Snapshot() (raft.FSMSnapshot, error) { return nil, nil }
func (f *Store) Restore(rc io.ReadCloser) error      { return nil }
