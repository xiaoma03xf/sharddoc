...
func convertValue(v kv.Value) (any, error) {
	switch v.Type {
	case kv.TYPE_INT64:
...
func scanRecordToStruct(record kv.Record, ptr any, fields map[string]reflect.Value) error {
...
func scanRecordsToStructs(records []kv.Record, ptrs []any) error {
