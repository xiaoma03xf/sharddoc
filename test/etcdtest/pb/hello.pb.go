...
func (x *HelloResponse) GetRequest() string {
	if x != nil {
		return x.Request
	}
	return ""
...
const file_hello_proto_rawDesc = "" +
	...
	"\aRequest\x18\x01 \x01(\tR\aRequest24\n" +
	"\n" +
	"HelloServe\x12&\n" +
	"\x05Hello\x12\r.HelloRequest\x1a\x0e.HelloResponseB\n" +
...
var file_hello_proto_depIdxs = []int32{
	0, // 0: HelloServe.Hello:input_type -> HelloRequest
	1, // 1: HelloServe.Hello:output_type -> HelloResponse
