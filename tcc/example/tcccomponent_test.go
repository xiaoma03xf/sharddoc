...
func Test_MockComponent_Try(t *testing.T) {
	...
	patch = patch.ApplyMethod(reflect.TypeOf(&redislock.Client{}), "Get", func(_ *redislock.Client, ctx context.Context, key string) (string, error) {
		switch key {
	...
	patch = patch.ApplyMethod(reflect.TypeOf(&redislock.Client{}), "Set", func(_ *redislock.Client, ctx context.Context, key string, value string) (int64, error) {
	...
	patch = patch.ApplyMethod(reflect.TypeOf(&redislock.Client{}), "SetNX", func(_ *redislock.Client, ctx context.Context, key string, value string) (int64, error) {
		switch key {
	...
	mockComponent := NewMockComponent("id", &redislock.Client{})
...
func Test_MockComponent_Cancel(t *testing.T) {
	...
	patch = patch.ApplyMethod(reflect.TypeOf(&redislock.Client{}), "Del", func(_ *redislock.Client, ctx context.Context, key string) error {
